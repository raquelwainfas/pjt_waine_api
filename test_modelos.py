...
# Parâmetros    
url_dados = "./MachineLearning/data/test_dataset_redwine.csv"
...
def test_modelo_lr():  
    ...
    lr_path = './MachineLearning/models/redwine_lr.pkl'
...
def test_modelo_knn():
    ...
    knn_path = './MachineLearning/models/redwine_knn.pkl'
...
def test_modelo_rf():
    ...
    rf_path = './MachineLearning/pipelines/rf_redwine_pipeline.pkl'
